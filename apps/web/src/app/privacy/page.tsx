  ...
  return (
    <div className="card" style={{ maxWidth: 640, margin: "40px auto" }}>
      ...
      <div className="fval">
        ...
        operational records (follow-up work we track on your household&apos;s behalf and the planned instances of your standing tasks with our internal working estimates for planning them, items
