    ...
    return [
      {
        ...
        headers: [
          ...
          // CSP is now ENFORCING with a per-request nonce — set in
          // src/middleware.ts (it needs the nonce, which static headers
          // can't carry). The other headers stay static here.
        ],
      },
    ];
  },
