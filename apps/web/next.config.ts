    ...
    return [
      {
        ...
        headers: [
          ...
          // CSP in REPORT-ONLY: collects violations without breaking the app,
          // so the pen pass can tighten to enforcing from real data. Next
          // inlines some styles/scripts, hence unsafe-inline here for now.
          {
