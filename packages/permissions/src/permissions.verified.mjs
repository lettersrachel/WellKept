/**
 * permissions.mjs : the Well Kept permission core.
 *
 ...
 */
export function readDecision(role, sensitivity, opts = {}) {
 ...
 */
export function filterFields(role, fields, opts = {}) {
 ...
 */
export function revealS3(session, field, auditSink, opts = {}) {
 ...
 */
export function assertClientPayloadSafe(payloadFields) {
