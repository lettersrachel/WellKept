...
test("the child-data policy document exists and classifies every capture surface (founder item 3)", () => {
  ...
  for (const surface of ["registry_entry", "playbook_field", "dot", "visit", "visit_photo", "incident_report", "condition_flag", "deferral", "paused_decision", "work_item", "attention_record", "decision_record", "shadow_log", "capture_artifact", "visit_brief_snapshot", "household_task_profile", "work_requirement", "estimate_snapshot"]) {
