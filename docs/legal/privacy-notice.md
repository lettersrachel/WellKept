...
| Operational records | follow-up work we track on your household's behalf and the planned instances of your standing tasks with our internal working estimates for planning them, items our system surfaces to our staff for attention, choices we route internally for a decision, notes a staff member captures in their own words for filing, the pre-visit briefs we show our staff (kept exactly as shown), and what our reminder engine would have suggested while we tune it | to run the service reliably |
