...
| Operational records | follow-up work we track on your household's behalf, items our system surfaces to our staff for attention, choices we route internally for a decision, notes a staff member captures in their own words for filing, and what our reminder engine would have suggested while we tune it | to run the service reliably |
