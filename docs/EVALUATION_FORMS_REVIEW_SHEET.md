...
Sources: `docs/intake/2026-09-04-founder-values/rubric_anchors.csv`, `docs/intake/2026-09-03-build-package/SPEC_MODE_LOGIC.md`.
...
| Source | `rubric_anchors.csv` (12 domains, anchors 2 to 5) | SPEC_MODE_LOGIC section 4 (5 items) |
...
**Domain tiers, counted from the source:** 4 high consequence, 4 core, 4 supporting.

### High consequence domains (4)

#### Contextual operating judgment
...
| 5 | Anticipates second-order effects across systems; documents so another HOM could act |

| Score | Evidence (visit, scenario, or observation) | Evaluator | Date |
|---|---|---|---|
| `_____` | `_____` | `_____` | `_____` |

#### Household relationship and boundaries
...
| 5 | Repairs a boundary the member did not know was crossed; member feels respected not managed |

| Score | Evidence (visit, scenario, or observation) | Evaluator | Date |
|---|---|---|---|
| `_____` | `_____` | `_____` | `_____` |

#### Prepared decisions and communication
...
| 5 | Member decisions fall over time because prepared decisions land inside standing authority |
...
| 5 | Identifies latent hazards on observation and files them without prompting |
...
| 5 | Manages the vendor bench; anticipates failures from condition |

| Score | Evidence (visit, scenario, or observation) | Evaluator | Date |
|---|---|---|---|
| `_____` | `_____` | `_____` | `_____` |

#### Household systems literacy
...
| 5 | Builds the household's systems map and horizon |
...
| 5 | Designs the household's NDA-mode practice |

| Score | Evidence (visit, scenario, or observation) | Evaluator | Date |
|---|---|---|---|
| `_____` | `_____` | `_____` | `_____` |

#### Software and record discipline
...
| 5 | Record improves the standard; redlines the Playbook |
...
| 5 | Maintains the regional service map |

| Score | Evidence (visit, scenario, or observation) | Evaluator | Date |
|---|---|---|---|
| `_____` | `_____` | `_____` | `_____` |

#### Project and transition coordination
...
| 5 | Designs the coordination cascade for a life event |
...
| 5 | Teaches cultural range to others |
...
| 5 | Adapts the household plan to preserve autonomy over time |
...
| Scenario id | `_____` |
| Trainee | `_____` |
| Observer (not the trainee) | `_____` |
| Date run | `_____` |
| Attempt number | `_____` |

**The 5 items, verbatim from the source:**

| Item | Score | Note |
|---|---|---|
| outcome | `_____` | `_____` |
| structure | `_____` | `_____` |
| understanding | `_____` | `_____` |
| escalation | `_____` | `_____` |
| failure modes | `_____` | `_____` |

**Verdict:** `_____` pass  ·  `_____` repeat  ·  `_____` module review
...
1. **The join between the two forms.** Does a scenario run feed a domain score,
   and if so which scenarios exercise which of the 12 domains? Until this is
